$fsx.f[57]=(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0});const s=$fsx.r(15);$fsx.r(55);const i=$fsx.r(16),r=$fsx.r(25),a=$fsx.r(56),o=$fsx.r(51),n=$fsx.r(18),c=$fsx.r(47),l=$fsx.r(48),h=$fsx.r(43),m=$fsx.r(49);function d(){return s.html`
        <div class="article-meta">
            ...
            <div class="info">
                ...
                <span class="date">${h(new Date(this.article.createdAt),"MMMM D, YYYY")}</span>
            </div>
    ...
    `}i.registerCustomElement("article-comp",class extends HTMLElement{constructor(){super(),this.comments=[],this.articleService=i.getContext(r.ArticleService),this.commentService=i.getContext(a.CommentService),this.userService=i.getContext(o.UserService),this.sharedState=i.getContext(n.SharedState),this.profileService=i.getContext(c.ProfileService)}async activate(t,e,s){this.slug=e.slug,this.article=await this.articleService.get(this.slug),this.comments=await this.commentService.getList(this.slug)||[]}onToggleFavorited(){this.sharedState.isAuthenticated?(this.article.favorited=!this.article.favorited,this.article.favorited?(this.article.favoritesCount++,this.articleService.favorite(this.article.slug)):(this.article.favoritesCount--,this.articleService.unfavorite(this.article.slug)),this.render()):location.hash="login"}onToggleFollowing(){this.sharedState.isAuthenticated?(this.article.author.following=!this.article.author.following,this.article.author.following?this.profileService.follow(this.article.author.username):this.profileService.unfollow(this.article.author.username),this.render()):location.hash="login"}async postComment(){const t=await this.commentService.add(this.slug,this.myComment);this.comments.push(t),this.myComment="",this.render()}get canModify(){return this.article.author.username===this.sharedState.currentUser.username}async deleteArticle(){await this.articleService.destroy(this.article.slug),location.hash="home",this.render()}async deleteComment(t){await this.commentService.destroy(t,this.slug),this.comments=await this.commentService.getList(this.slug),this.render()}markedhtml(t){let e;if(t){const s=new l.Renderer;e=l(t,{renderer:s})}else e="";return e}render(){return console.log("loaded"),s.html`
            ...
            `}})},$fsx.f[55]=(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0});const s=$fsx.r(15),i=$fsx.r(16),r=$fsx.r(18),a=$fsx.r(4),o=$fsx.r(43);i.registerCustomElement("comment-section",class extends HTMLElement{get canModify(){return this.comment.author.username===this.sharedState.currentUser.username}deleteCb(t){}constructor(){super(),this.sharedState=i.getContext(r.SharedState)}render(){return s.html`
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <span class="date-posted">${o(new Date(this.comment.createdAt),"MMMM D, YYYY")}</span>
            ...
            `}})},$fsx.f[56]=(t,e)=>{Object.defineProperty(e,"__esModule",{value:!0});const s=$fsx.r(23),i=$fsx.r(16);e.CommentService=class{constructor(){this.apiService=i.getContext(s.ApiService)}async add(t,e){return(await this.apiService.post(`/articles/${t}/comments`,{comment:{body:e}})).comment}async getList(t){return(await this.apiService.get(`/articles/${t}/comments`)).comments}async destroy(t,e){return await this.apiService.delete(`/articles/${e}/comments/${t}`)}}};