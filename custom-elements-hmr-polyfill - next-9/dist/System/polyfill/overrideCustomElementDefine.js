System.register(["./hmrCache", "./createHookClass", "./constructInstance"], function (exports_1, context_1) {
    "use strict";
    var hmrCache_1, createHookClass_1, constructInstance_1;
    ...
    exports_1("overrideCustomElementDefine", overrideCustomElementDefine);
    return {
        setters: [
            function (hmrCache_1_1) {
                hmrCache_1 = hmrCache_1_1;
            },
            function (createHookClass_1_1) {
                createHookClass_1 = createHookClass_1_1;
            },
            function (constructInstance_1_1) {
                constructInstance_1 = constructInstance_1_1;
            }
        ],
        execute: function () {
        }
