$fsx.f[49]=(e,t)=>{Object.defineProperty(t,"__esModule",{value:!0});const o=$fsx.r(12),r=$fsx.r(23),l=$fsx.r(28),a=$fsx.r(47);$fsx.r(48);let n=class extends HTMLElement{async activate(){this.workpackService=l.instance(a.WorkpackService),this.wp=await this.workpackService.getAll()}render(){return r.html`
